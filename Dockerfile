...
RUN pip install -q opencv-python imageio imageio-ffmpeg ffmpeg-python av runpod \
    numpy==1.26.4 transformers==4.39.2 diffusers==0.27.2 accelerate==0.28.0 huggingface_hub==0.24.6 omegaconf mmpose mmdet moviepy==1.0.3 soundfile \
...
RUN mkdir -p /home/camenduru/nltk_data && python3 -m nltk.downloader -d /home/camenduru/nltk_data punkt punkt_tab averaged_perceptron_tagger cmudict
